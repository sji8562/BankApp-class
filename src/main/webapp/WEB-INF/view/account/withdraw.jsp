	  ...
	  <div class="bg-light p-md-5 h-75">
      	...
      	<form action="/account/withdraw" method="post">
  			<div class="form-group">
    			...
    			<input type="text" class="form-control amount" placeholder="Enter amount" id="amount" name="amount" value="100">
  			</div>
  			<div class="form-group">
    			<label for="wAccountNumber">출금 계좌번호:</label>
    			<input type="text" class="form-control wAccountNumber" placeholder="Enter wAccountNumber" id="wAccountNumber" name="wAccountNumber" value="9999">
  			</div>
  			<div class="form-group">
